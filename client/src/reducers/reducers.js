...
const initialState = {
  ...
  appartment: {city: '', size: '', numberOfPersons: '', photos: [], nationalties: [], rentalPeriod: '', depositAmount: '', sex: '', description: '' },
  price: 1, 
  proposalId: '',
  clientId: '',
  clientName:'',
...
const slice = createSlice({
  ...
  reducers: {
    ...
    setAppartmentCity: (state, action)=>{
      state.overview = action.payload
    },
