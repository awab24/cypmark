...
function SellPositionCompetitors() {
  ...
  useEffect(() => {
    const fetchApartments = async () => {
      try {
        const response = await axios.get('http://localhost:3000/api/endpoints/sellPositions'); // Adjust the endpoint accordingly
                ...
                <Card>
                  ...
                  <Card.Body style={{backgroundColor: 'yellow', color:'black'}}>
                    ...
                    <Card.Text>
                      ...
                      <strong>is it shared ?</strong> {apartment.sharedRoom}<br/>
                    </Card.Text>
                  </Card.Body>
                </Card>
...
export default SellPositionCompetitors;
